...
| `assets/wizualizacje/kronika-tom-1-epoka-1.jpg` | generowane narzędziem AI z promptu epoki 1 | wygenerowane na potrzeby projektu | hiperrealistyczna kinowa fotografia 21:9, ≤ 2 MB; prompt w `data/kronika/epoka-1.json:grafika` |
| `assets/wizualizacje/kronika-tom-1-epoka-2.jpg` | generowane narzędziem AI z promptu epoki 2 | wygenerowane na potrzeby projektu | j.w. (`data/kronika/epoka-2.json:grafika`) |
| `assets/wizualizacje/kronika-tom-1-epoka-3.jpg` | generowane narzędziem AI z promptu epoki 3 | wygenerowane na potrzeby projektu | j.w. (`data/kronika/epoka-3.json:grafika`) |
| `assets/wizualizacje/kronika-tom-1-epoka-4.jpg` | generowane narzędziem AI z promptu epoki 4 | wygenerowane na potrzeby projektu | j.w. (`data/kronika/epoka-4.json:grafika`) |
| `assets/wizualizacje/kronika-tom-1-epoka-5.jpg` | generowane narzędziem AI z promptu epoki 5 | wygenerowane na potrzeby projektu | j.w. (`data/kronika/epoka-5.json:grafika`) |
| `assets/wizualizacje/kronika-tom-1-epoka-6.jpg` | generowane narzędziem AI z promptu epoki 6 | wygenerowane na potrzeby projektu | j.w. (`data/kronika/epoka-6.json:grafika`) |
| `assets/wizualizacje/kronika-tom-1-epoka-7.jpg` | generowane narzędziem AI z promptu epoki 7 | wygenerowane na potrzeby projektu | j.w. (`data/kronika/epoka-7.json:grafika`) |
...
i Esri World Imagery. Zoom online sięga **technicznego maksimum źródeł**:
docelowe serwisy kafelków mają z≈19, więc `K_MAX_ONLINE = 2**19 =
524288×` (rozdzielczość kafelków „piksel w piksel” przy typowym oknie).
Wcześniejsza blokada wg **67 obrotów kółka** (×45 252) została wycofana
decyzją właściciela 2026-08-30 — różne rejony świata mają różny maksymalny
zoom, więc o limicie decyduje specyfikacja źródeł, nie długość scrolla.
