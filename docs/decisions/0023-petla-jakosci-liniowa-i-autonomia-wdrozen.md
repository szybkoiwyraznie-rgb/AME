...
1. **Pętla Jakości staje się sekwencją liniową, bez zapętlenia:**
   **C4 → C1 → C3 → C6 → C2+5**. Sesja wykonuje jedno przejście (tyle, ile
   ...
   - **C3 — SKIT do Bazy Skitów** (jak dotychczas: 2–4 materializacje
     o unikalnym składzie, PROTOKÓŁ §8.4) — krok OSOBNY.
   ...
   - **C2+5 — DEVELOPMENT (scalone):** nowe featury aplikacji ORAZ grube
     ...
     z materializacjami), konkretyzowane z `docs/BACKLOG.md`; z testami.
